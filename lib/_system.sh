...
system_git_clone() {
  ...
  sudo su - deploy <<EOF
  git clone ${link_git} /www/wwwroot/perfisvips.com.br/${instancia_add}/
EOF
...
sudo su - deploy <<EOF
 rm -rf /www/wwwroot/perfisvips.com.br/${empresa_delete}
...
sleep 2
  ...
  sudo su - deploy <<EOF
  cd && cd /www/wwwroot/perfisvips.com.br/${empresa_dominio}/frontend
  sed -i "1c\REACT_APP_BACKEND_URL=https://${alter_backend_url}" .env
  cd && cd /www/wwwroot/perfisvips.com.br/${empresa_dominio}/backend
